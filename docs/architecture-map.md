...
| `query-family.mjs` | Registered query families over host + typed value catalog/elements; clients name a family and pass a validated field id (ADR-0009 phase 2) |
